    ...
    <div className="page database-unavailable-page">
      <div className="database-unavailable-card" role="alert">
        ...
        <ul className="database-unavailable-checklist">
          <li>
            <strong>Start Postgres</strong> (e.g. run <code>./setup/setup.sh</code> from the repo
            root, or your local service).
          </li>
          <li>
...
// eslint-disable-next-line react-refresh/only-export-components -- colocated helpers
