...
export function ShotClockView() {
  ...
  return (
    <div className="arena-page arena-shot">
      <button type="button" className="arena-settings-btn" onClick={() => setShowSetup(true)}>
        Settings
      </button>
      <div className="arena-shot-main">
        <TickClock clock={aggregate.shotClock} className="arena-shot-digits" />
      </div>
      <div className="arena-shot-sub">Shot clock</div>
    </div>
  );
}
